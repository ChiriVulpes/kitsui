...
- Go **broad to narrow**:
	1. Start with semantic codesearch to discover relevant areas
...
- Do not read other agent instruction files or documentation. Explore only code.
...
- Parallelize independent tool calls such as multiple reads
...
- Make sure to remind the main agent, with bold & capital letters, that this is an exploratory summary and should NOT be used as a source of truth. That when finalising plans and making code changes, the main agent should ALWAYS read the relevant parts of of the relevant files itself.
