...
describe("build:docs pipeline", () => {
	it("emits the docs site, the typedoc json model, and every expected page", async () => {
		...
		expect(groupSectionHtml.includes('id="GroupedStateObject"'), "groupExtension declarations should render in the groupExtension section").toBe(true);
		expect(groupSectionHtml.includes('id="GroupedValue"'), "groupExtension type declarations should render in the groupExtension section").toBe(true);
